...
class BaseTracker_Adapter(metaclass=abc.ABCMeta):
	"""Tracker Base Class.
	"""
	...
	def update(self, detections: Any, *args, **kwargs):
		...
		"""
		logger.error("``update()`` has not been implemented yet")
	...
	def update_matched_tracks(
		...
		Args:
			...
			detections (any):
				The newly detections.
		"""
		logger.error("``update_matched_tracks()`` has not been implemented yet")
		raise NotImplementedError
	...
	def create_new_tracks(
		...
		Args:
			...
			detections (any):
				The newly detections.
		"""
		logger.error("``create_new_tracks()`` has not been implemented yet")
		raise NotImplementedError
	
	def delete_dead_tracks(self):
		"""Delete dead tracks.
		"""
		logger.error("``delete_dead_tracks()`` has not been implemented yet")
		raise NotImplementedError
	...
	def associate_detections_to_tracks(self, dets: Any, trks: Any, **kwargs):
		...
		"""
		logger.error("``associate_detections_to_trackers()`` has not been implemented yet")
		raise NotImplementedError
