...
parser.add_argument(
	"--config", default="pbvs26_thermal_mot.yaml",
	help="Config file for each camera. Final path to the config file."
)
parser.add_argument(
	"--dataset", default="pbvs26_thermal",
...
parser.add_argument(
	"--detection_reid", action='store_true', help="Should run re-identification for detection process."
)
parser.add_argument(
	"--tracking", action='store_true', help="Should run tracking process."
)
parser.add_argument(
	"--tracking_reid", action='store_true', help="Should run post tracking reidentification process."
)
parser.add_argument(
...
def main():
	...
	camera_cfg["process"]      = {
		...
		"function_detection_reid": args.detection_reid, # Re-Identification for detection
		"function_tracking"      : args.tracking      , # Tracking
		"function_tracking_reid" : args.tracking_reid , # Post Reidentification
